...
1. **Titanic Dataset Visualization**
2. **Coffee Chain Dataset Visualization**

Each project demonstrates practical data analysis and visualization using Tableau’s key features such as heat maps, box plots, bar charts, scatter plots, pie charts, and interactive dashboards.

---

# 🚢 **1️⃣ TITANIC DATASET VISUALIZATION**

### 📘 Dataset Description:
The Titanic dataset provides information about passengers on the RMS Titanic, including age, gender, class, fare, and survival status.  
This visualization explores survival trends and demographic relationships using Tableau.

### 🧭 Steps Performed:
1. **Bar Chart:** Passengers by Gender.  
...
5. **Scatter Plot:** Age vs. Fare relationship.  
6. **Box Plot:** Fare distribution by Passenger Class.  
7. **Heat Map:** Survival rate by Gender and Class.  
8. **Pie Chart:** Gender distribution of passengers.  
9. **Dashboard:** Combined interactive view of all visuals for deeper insights.
...
# ☕ **2️⃣ COFFEE CHAIN DATASET VISUALIZATION**
...
The goal is to analyze business performance and identify high and low profit areas.
...
### 🧩 Key Insights:
- **Espresso** showed lowest profit in several western states.  
- **Caffe Mocha** and **Colombian Coffee Beans** were top profit generators.  
- **Central region’s top 5 products** contributed over 70% of total sales.  
- **California** had the highest sales and profit performance overall.  
- Clear visualization of profit trends enables better marketing and inventory strategies.
